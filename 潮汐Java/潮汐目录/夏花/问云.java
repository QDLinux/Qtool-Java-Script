...
public final String myqun="183611200";
...
textView.setText("潮汐 3.2 更新内容");
			textView.setTextSize(30);
textView.setTextColor(Color.parseColor("#1E90FF"));
			TextView textView1 = new TextView(ThisActivity);	
		textView1.setText("好久没更新了，没办法，累也忙，也不知道还有多少人在用在等，修复了违禁词处理方式，修复了使用方法 \"简取(File)\" 时没有及时关闭回收IO流的资源导致的问题，本脚本不含云端功能，也可能不再打算更新，嗯...");

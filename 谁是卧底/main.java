...
public class TimeType {
    ...
    public static final int maxTime = 60*10;//最长游戏时间
    public static final int daytimeTime = 30;//白天时间
    public static final int votingTime = 30;//白天投票时间
    public static final int nightTime = 35;//黑夜时间

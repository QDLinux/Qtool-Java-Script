...
public static String SearchQQMusicList(String searchName)
{
    if(searchName != null && !searchName.isEmpty())
    {
        try
        {
            ...
            String jsonStr = post("http://u.y.qq.com/cgi-bin/musicu.fcg","{\"comm\":{\"format\":\"json\",\"inCharset\":\"utf-8\",\"outCharset\":\"utf-8\",\"notice\":0,\"platform\":\"h5\",\"needNewCode\":1,\"ct\":23,\"cv\":0},\"req_0\":{\"method\":\"DoSearchForQQMusicDesktop\",\"module\":\"music.search.SearchCgiService\",\"param\":{\"remoteplace\":\"txt.mqq.all\",\"searchid\":\"70727550102537268\",\"search_type\":0,\"query\":\""+searchName+"\",\"page_num\":1,\"num_per_page\":50}}}");
